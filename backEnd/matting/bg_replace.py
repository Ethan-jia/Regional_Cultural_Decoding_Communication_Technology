...
# pip install paddleseg -i https://pypi.tuna.tsinghua.edu.cn/simple
# pip install protobuf==3.20.0 -i https://pypi.tuna.tsinghua.edu.cn/simple
#
# python bg_replace.py --config export_model/deeplabv3p_resnet50_os8_humanseg_512x512_100k_with_softmax/deploy.yaml --video_path data/C0299.MP4
# python bg_replace.py --config export_model/deeplabv3p_resnet50_os8_humanseg_512x512_100k_with_softmax/deploy.yaml --bg_video_path data/bbb.mp4 --video_path data/C0299.MP4
# python bg_replace.py --config export_model/deeplabv3p_resnet50_os8_humanseg_512x512_100k_with_softmax/deploy.yaml --bg_img_path data/bb.jpeg --video_path data/C0299.MP4


# test
# python bg_replace.py --config export_model/deeplabv3p_resnet50_os8_humanseg_512x512_100k_with_softmax/deploy.yaml --bg_video_path data/1b.mp4 --video_path data/1a.MP4
# python bg_replace.py --config export_model/deeplabv3p_resnet50_os8_humanseg_512x512_100k_with_softmax/deploy.yaml --bg_video_path data/2b.mp4 --video_path data/2a.mp4
...
def background_replace(args):
    ...
    # 视频背景替换
        ...
        if args.video_path is not None:
            logger.info('Please wait. Parameter is computing......')
